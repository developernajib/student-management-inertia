...
const deleteStudent = async (id) => {
    if (confirm("Are you sure you want to delete this student?")) {
        try {
            await deleteForm.delete(route("students.destroy", id), {
                preserveScroll: true,
            });
            $toast.open({
            ...
            $toast.open({
                message: "Got error while deleting student, please try again !",
                type: 'error',
                position: 'top-right',
            });
        }
                                    ...
                                    <table class="min-w-full divide-y divide-gray-300">
                                        ...
                                        <tbody class="divide-y divide-gray-200 bg-white">
                                            <tr v-for="student in students.data" :key="student.id">
                                                ...
                                                <td v-if="student.formatted_updated_at && student.formatted_updated_at !== student.created_at_formatted"
                                                    class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                    {{ student.formatted_updated_at }}
                                                </td>
